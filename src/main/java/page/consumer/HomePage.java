...
public class HomePage extends abstractPage {
	...
	public void addDefaultItem() {
		...
		driver.findElement(By.xpath("(//input[@value='Add to cart'])[3]"))
				.click();
	...
	public void changecurrency(String currency) {
		...
		(new Select(driver.findElement(By.id("customerCurrency"))))
	...
	public void gotomyaccount() {
		...
		driver.findElement(By.xpath("//div[@class='header-menu']/ul/li[4]/a"))
				.click();
	...
	public void selectproduct(String product) {
		// TODO Auto-generated method stub
		/*
		 * sel.click("link="+product); sel.waitForPageToLoad("30000");
		 */
		driver.findElements(By.linkText(product));
	...
	public static boolean verifypolling() {
		boolean verify = CommonUtil.isTextPresent("Good")
				&& CommonUtil.isTextPresent("vote(s) - 100.0%)");
