...
public class CoreResources {
    ...
    private static final Logger LOGGER = Logger.getLogger(com.venkyold.org.adv.utils.CoreResources.class);
...
//    }
    ...
    public static File getFile(String fileName, boolean throwErrorOnFileNotFound) {
        ...
        if (!file.exists()) file = FileUtils.toFile(com.venkyold.org.adv.utils.CoreResources.class.getClassLoader().getResource(fileName));
