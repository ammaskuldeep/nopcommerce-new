...
import com.venkyold.org.adv.utils.CoreSystemProperty;
...
import static com.venkyold.org.adv.utils.StringConversionUtils.toBoolean;


public class CoreProperties {

    private static final Logger LOGGER = Logger.getLogger(com.venkyold.org.adv.utils.CoreProperties.class);
...
//    private final String ENVIRONMENT_OVERRIDE_PROPERTIES = getSystemProperty(TEST_ENV) + PROPERTIES_EXTENSION;
    ...
    private static com.venkyold.org.adv.utils.CoreProperties instance;
...
//        properties = getAllProperties(basePropertiesFile, environmentOverridePropertiesFile, userOverridePropertiesFile);
    ...
    public static com.venkyold.org.adv.utils.CoreProperties getNewJacuzziProperties() {
        return new com.venkyold.org.adv.utils.CoreProperties();
    }

    public static com.venkyold.org.adv.utils.CoreProperties getJacuzziProperties() {
        if (instance == null) {
    ...
    public static boolean getBooleanSystemProperty(CoreSystemProperty systemProperty) {
        ...
        return toBoolean(property) || (System.getProperties().containsKey(systemProperty.getPropertyName()) && property.isEmpty());
    }
    ...
    public com.venkyold.org.adv.utils.CoreProperties withLogging(boolean logging) {
