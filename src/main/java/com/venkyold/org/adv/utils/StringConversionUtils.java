...
import com.venkyold.org.adv.utils.StringUtils;
...
import static com.venkyold.org.adv.utils.StringConstants.*;
...
//    }
    ...
    public static String[] splitWithNoBlanks(String stringToSplit, String separator) {
        ...
        List<String> splitStringsAsList = new ArrayList<String>(asList(splitStrings));
...
//    }
    ...
    public static <T> T valueForType(String value, Class<T> returnType, boolean allowNullsToBeReturned) {
        ...
        if (returnType.equals(Long.class)) return (T) com.venkyold.org.adv.utils.StringConversionUtils.toLong(value);
        if (returnType.equals(Double.class)) return (T) com.venkyold.org.adv.utils.StringConversionUtils.toDouble(value);
        if (returnType.equals(Boolean.class)) return (T) com.venkyold.org.adv.utils.StringConversionUtils.toBoolean(value);
        if (returnType.equals(Float.class)) return (T) com.venkyold.org.adv.utils.StringConversionUtils.toFloat(value);
        if (returnType.equals(Integer.class)) return (T) com.venkyold.org.adv.utils.StringConversionUtils.toInteger(value);
        try {
