...
import static org.openqa.jetty.util.StringUtil.endsWithIgnoreCase;
import static org.openqa.jetty.util.StringUtil.startsWithIgnoreCase;
...
//    }
    ...
    public static String leftPadWithZerosToFixedLength(String inputValue, Integer returnStringLength) {
        String result = com.venkyold.org.adv.utils.StringUtils.repeat("0", returnStringLength) + inputValue;
    ...
    public static String rightPadWithZerosToFixedLength(String inputValue, Integer returnStringLength) {
        String result = inputValue + com.venkyold.org.adv.utils.StringUtils.repeat("0", returnStringLength);
...
//    }
    ...
    public static String removeQuotes(String value) {
        if (com.venkyold.org.adv.utils.StringUtils.isNotBlank(value)) {
    ...
    public static boolean containsAllIgnoreCase(String searchIn, Iterable<String> searchFor) {
        for (String string : searchFor) {
            if (!com.venkyold.org.adv.utils.StringUtils.containsIgnoreCase(searchIn, string)) return false;
        }
        return true;
    }
    ...
    public static boolean containsAnyIgnoreCase(String searchIn, Iterable<String> searchFor) {
        for (String string : searchFor) {
            if (com.venkyold.org.adv.utils.StringUtils.containsIgnoreCase(searchIn, string)) return true;
        }
        return false;
    }
