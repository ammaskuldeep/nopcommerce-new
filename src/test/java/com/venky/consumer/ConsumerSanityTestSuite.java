...
public class ConsumerSanityTestSuite extends abstractTest {

        String email = "roopa9@gmail.com";
...
//        String password1 = "roopa1234";
    ...
    public void verifyLogin()
    {
        ...
        LoginPage loginPage = new LoginPage();
        loginPage.login(email,password,first,last);
        REPORTER.Log("login");
        //veirfy user has loogged in
        REPORTER.isTrue(loginPage.IsconsumerLoggedin());
...
//        REPORTER.Log("logout");
   ...
   // @Test
    public void newproduct()
    {
        ...
        productPage.gotoproduct("Computers");


        productPage.gotoproduct("laptop");

        REPORTER.Log("selectproduc");

        //select a category
        productPage.gotoproduct("Desktops");
        REPORTER.Log("selectprodu");


      //  productPage.selectproduct("laptop");
      //  REPORTER.Log("selectpro
        productPage.gotoproduct("mylaptop");
        REPORTER.Log("selectproduct");

        //Select a product

        productPage.gotoproduct("Build your own computer");
        REPORTER.Log("selectprod");
       // productPage.selectproduct("Build your own mylaptop");
      //  productPage.selectproduct("Build your own laptop");
        // REPORTER.Log("selectproduct");
    ...
    public void VerifycompareList()
    {
    	HomePage homePage  =  new HomePage();
    	       homePage.gotoHomepage();
    	        ...
    	        //select the item
    	        ProductPage productPage  =  new ProductPage();
    	        productPage.selectproduct("mylaptop");
    	        ...
    	        productPage.selectproduct("laptop");
    	        REPORTER.Log("selectproduct");
    	        REPORTER.isTrue(productPage.isItemsAdded("MyLaptop", "laptop"));
...
//        REPORTER.Log("logout");
  ...
  //  @Test
    ...
    String email1 = "roopa5@gmail.com";
    String password1 = "roopa1234";
    String RecipientsName="Rahul";
    String RecipientsEmail="selenium5abc@gmail.com";
    String YourName="madhu";
    String YourEmail="selenium6abc@gmail.com";
